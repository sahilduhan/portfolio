    ...
    <div>
        <i class="bi bi-list mobile-nav-toggle d-xl-none" />
            ...
            <ul>
                ...
                <li><a href="#skills" class="nav-link scrollto"><i class="bx bx-basketball"></i> <span>Skills</span></a></li>
                ...
                <li><a href="#achievements" class="nav-link scrollto"><i class="bx bx-medal"></i> <span>Achievements</span></a></li>
